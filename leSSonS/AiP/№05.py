'''Определить наименьшее расстояние между двумя локальными максимумами последовательности натуральных чисел,
оканчивающейся нулем. Если нет двух локальных максимумов, то вывести 0. '''
